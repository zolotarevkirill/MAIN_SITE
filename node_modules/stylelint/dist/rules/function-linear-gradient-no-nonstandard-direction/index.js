  ...
  return function (root, result) {
    ...
    root.walkDecls(function (decl) {
      (0, _utils.functionArgumentsSearch)(decl.toString().toLowerCase(), "linear-gradient", function (expression, expressionIndex) {
        ...
        var withToPrefix = !_postcss.vendor.prefix(decl.value);
...
var messages = exports.messages = (0, _utils.ruleMessages)(ruleName, {
  rejected: "Нестандартное объявление направления"
});

function isStandardDirection(source, withToPrefix) {
  var regexp = withToPrefix ? /^to (top|left|bottom|right)(?: (top|left|bottom|right))?$/ : /^(top|left|bottom|right)(?: (top|left|bottom|right))?$/;
