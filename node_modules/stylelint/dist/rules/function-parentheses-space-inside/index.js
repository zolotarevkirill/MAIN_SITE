...
var messages = exports.messages = (0, _utils.ruleMessages)(ruleName, {
  expectedOpening: "Нужен пробел после \"(\"",
  rejectedOpening: "Лишний пробел после \"(\"",
  expectedClosing: "Нужен пробел перед \")\"",
  rejectedClosing: "Лишний пробел перед \")\"",
  expectedOpeningSingleLine: "Нужен пробел после \"(\" в однострочной функции",
  rejectedOpeningSingleLine: "Лишний пробел после \"(\" в однострочной функции",
  expectedClosingSingleLine: "Нужен пробел перед \")\" в однострочной функции",
  rejectedClosingSingleLine: "Лишний пробел перед \")\" в однострочной функции"
});